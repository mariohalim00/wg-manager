...
>
	...
	<div class="glass-card animate-slide-up w-full max-w-lg p-6" onclick={(e) => e.stopPropagation()}>
		...
		<!-- Success message -->
		<div class="mb-6 rounded-lg border border-green-500/40 bg-green-500/20 p-4">
		...
		<!-- Security warning -->
		<div class="mb-6 rounded-lg border border-yellow-500/40 bg-yellow-500/20 p-3">
		...
		<div class="flex flex-col gap-3">
			<button onclick={onDownload} class="glass-btn-primary w-full px-6 py-3">
